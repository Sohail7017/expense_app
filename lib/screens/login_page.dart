  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: MediaQuery.of(context).orientation== Orientation.landscape ? Row(children: [loginUi()],) : loginUi()
      )
    );
  }
  Widget loginUi(){
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Center(child: Text('Monety',style: TextStyle(fontSize: 30,color: isLight?Colors.black : Colors.white,fontWeight: FontWeight.bold),)),
          Text('Please enter your details to Sign in.',style: TextStyle(fontSize: 18,color: isLight?Colors.black54: Colors.white ,fontWeight: FontWeight.w500),),
          SizedBox(
            height: 20,
          ),
          Row(
            ...
            children: [
              Container(
                ...
                child: IconButton(onPressed: (){}, icon: Image.asset("assets/icons/apple.png",color: isLight?Colors.black54: Colors.white,width: 40,height: 40,)),
              ),
              Container(
                width: 100,
                height: 50,
          ...
          Text('OR',style: TextStyle(fontSize: 25,color: isLight?Colors.black54: Colors.white),),
          SizedBox(
            height: 20,
          ),
          TextField(
            ...
            decoration: InputDecoration(
                ...
                enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(color: isLight?Colors.black54: Colors.white,width: 2)
                )
            ),
          ),
          SizedBox(
          ...
          TextField(
            ...
            decoration:  InputDecoration(
                ...
                helperStyle: TextStyle(fontSize: 17,color: isLight?Colors.black54: Colors.white),
          ...
          Row(
            ...
            children: [
              ...
              Text('Remember Me ',style: TextStyle(fontSize: 17,color: isLight?Colors.black54: Colors.white,),),
              SizedBox(
                width: 60,
              ),
              Text('Forget Password?',style: TextStyle(fontSize: 17,color: isLight?Colors.black54: Colors.white,fontWeight: FontWeight.w500,decoration: TextDecoration.underline,
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.center,
            children: [
              Text("Don't have an Account yet? ",style: TextStyle(fontSize: 18,color: isLight?Colors.black54: Colors.white,fontWeight: FontWeight.w400)),
              InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context) => SignUpPage()));
                  },
                  child: Text("Sign up",style: TextStyle(fontSize: 18,color: isLight?Colors.black54: Colors.white,fontWeight: FontWeight.bold,decoration: TextDecoration.underline)))
            ],
          )
